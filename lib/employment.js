...
function createResourceCard(resource, i) {
    ...
    name.className = 'employment-resource__name';
    $(card).append(name)
    ...
    $('.employment-resource__name').text(resource.attributes.name);
    $('.employment-resource__description').text(resource.attributes.description);
}